...
from bot.cogs.absence_cog import _next_raid_reminder_time_et, _build_raid_reminder_message
...
def test_next_raid_reminder_time_et_after_reminder():
    ...
    assert _next_raid_reminder_time_et(now) == datetime(2026, 9, 25, 20, 45, 0, tzinfo=ET)
